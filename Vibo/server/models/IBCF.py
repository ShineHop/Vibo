...
conn = pymysql.connect(host='52.79.237.117', port=3306, user='user1', password='12345678', db='itemdb', charset='utf8', autocommit=True, cursorclass=pymysql.cursors.DictCursor)
cursor1 = conn.cursor()
cursor2 = conn.cursor()
