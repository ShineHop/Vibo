...
conn = pymysql.connect(host='3.34.45.236', port=3306, user='user1', password='0000', db='itemdb', charset='utf8', autocommit=True, cursorclass=pymysql.cursors.DictCursor)
cursor1 = conn.cursor()
cursor2 = conn.cursor()
