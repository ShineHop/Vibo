...
const All=({userID})=>{
  ...
  useEffect(() => { 
    axios.get('http://172.30.1.34:3001/api/user/2023052706/like').then((response)=>{
  ...
  const ButtonClicked=(id)=>{
    ...
    axios.post('http://172.30.1.34:3001/api/user/2023052706/like/'+ id +'/update').then((response)=>
    {    
