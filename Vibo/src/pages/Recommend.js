    ...
    async function temp(){
      ...
      console.log("userID 1: ", userID);
        ...
        try{              // userinfo의 회원가입한 사람 수 받아오기
          axios.get('http://52.79.237.117:3001/api/user/'+userID+'/recommend/count').then((num_res)=>{
            ...
            if (num_res.data.data < 15) {
              ...
              try{
                axios.get('http://52.79.237.117:3001/api/user/'+userID+'/recommend').then((response)=>{
              ...
              try{
                axios.get('http://52.79.237.117:3001/api/user/'+userID+'/recommend/ubcf').then((response)=>{
