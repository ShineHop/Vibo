...
useEffect(() => { 
  async function fetchScore(){
    await axios.get('http://172.30.1.35:3001/api/user/2023052706/ratings/'+itemid).then((response)=>
    { 
  ...
  async function Likeornot(){
    await axios.get('http://172.30.1.35:3001/api/user/2023052706/like/'+itemid).then((response)=>{
...
{            return(
  ...
  const ButtonClicked=(id)=>{
    ...
    {await axios.post('http://172.30.1.35:3001/api/user/2023052706/like/'+ itemid +'/update').then((response)=>
    ...
    async function IBCFList(){
      await axios.get('http://172.30.1.35:3001/api/user/IBCF/'+itemid).then((response)=>{
        console.log(response.data);
...
const RatingUpdated=([scores])=>{
  axios.post('http://172.30.1.35:3001/api/user/2023052706/ratings/'+ itemid +'/update/'+scores).then((response)=>
  { console.log(response);
    if(response.ok){
